<template>
    <div class="container">
        ...
        <form action="" class="form">
            <input :required="true" ref="emailPhoneRef" class="input" type="email" name="email"
                @blur="checkEmailOrPhone" @focus="changeValueColor" placeholder="邮箱/手机号">
            <input :required="true" class="input" type="password" name="password" id="password" placeholder="密码">
